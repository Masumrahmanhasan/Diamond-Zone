    ...
    AIZ.uploader = {
        ...
        showSelectedFiles: function() {
            $('[name="aiz-show-selected"]').on("change", function() {
                if ($(this).is(":checked")) {
                    ...
                    //     ].aria_hidden = false;
                    // }
                    AIZ.uploader.getAllUploads("/aiz-uploader/get_uploaded_files");
                }
                AIZ.uploader.updateUploaderFiles();
            });
        },
                ...
                if (data.length > 0) {
                    for (var i = 0; i < data.length; i++) {
                        ...
                        if (data[i].type === "image") {
                            if (data[i].file_name.indexOf("https:") > -1) {
                                thumb =
                                    '<img src="' +
                                    data[i].file_name +
                                    '" class="img-fit">';
        ...
        inputSelectPreviewGenerate: function(elem) {
            ...
            if (AIZ.uploader.data.selectedFiles.length > 0) {
                ...
                $.post("/aiz-uploader/get_file_by_ids", { _token: AIZ.data.csrf, ids: AIZ.uploader.data.selectedFiles.toString() },
                    function(data) {
                        ...
                        if (data.length > 0) {
                            ...
                            for (
                                ...
                                var html =
                                    ...
                                    '<svg xmlns="http://www.w3.org/2000/svg" class="icon icon-xxs" viewBox="0 0 20 20" fill="currentColor"><path fill-rule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>' +
                                    "</button>" +
                                    "</div>" +
                                    "</div>";
        ...
        trigger: function(
            ...
            // setTimeout(function() {
            $.post(AIZ.data.uploadUrl, { _token: AIZ.data.csrf }, function(data) {

                    $("body").append(data);
                    $("#aizUploaderModal").modal("show");
                    AIZ.plugins.aizUppy();
                    AIZ.uploader.getAllUploads("/aiz-uploader/get_uploaded_files",null, $('[name="aiz-uploader-sort"]').val());
                    AIZ.uploader.updateUploaderSelected();
        ...
        previewGenerate: function() {
            $('[data-toggle="aizuploader"]').each(function() {
                ...
                $.post("/aiz-uploader/get_file_by_ids", { _token: AIZ.data.csrf, ids: files },
                    function(data) {
