		...
		<div class="row mt-4">
				...
				<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
						<div class="d-block mb-4 mb-md-0">
								...
								<h2 class="h4">Update Sub Category</h2>
														...
														<div class="col-lg-12 col-sm-6">
																...
																<div class="mb-4">
																		...
																		<input type="text" name="name" class="form-control @error('name') is-invalid @enderror"
																				id="subcategory_name" value="{{ $subcategory->name }}">
																		@error('name')
																...
																<div class="mb-4">
																		...
																		<input type="text" name="slug" class="form-control" id="subcategory_slug" readonly value="{{ $subcategory->slug }}">
...
@push('scripts')
		<script>
          ...
          category_name.addEventListener('load', function() {
